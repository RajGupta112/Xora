      ...
      <Element name="pricing">
        <div className="container">
          ...
          <div className='relative z-2 flex items-center justify-center'>
            <div className={clsx("h-num flex items-start",index===1 ? "text-p3" :"text-p4")}>$<Countup start={plan.priceMonthly} end={monthly ? plan.priceMonthly : plan.priceYearly} duration={0.4} useEasing={false} preserveValue></Countup></div>
...
{plan.features.map((feature)=>(<li key={feature} className='relative flex items-center gap-5'>
